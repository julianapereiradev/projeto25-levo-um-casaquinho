...
export default function TakeACoatPage() {
  ...
  function dateFormatter(date) {
    ...
    return `${testDate.getDate()}/${testDate.getMonth() + 1} (${
          ...
          {Object.keys(weather).length !== 0 ? (
            <>
              <LeftBoxTemperature>
                ...
                <h2 style={{ color: temperatureColor }}>
              ...
              <LeftBoxInfo>
                ...
                <h5>
                  {dataConvertida.diaDaSemana}, {dataConvertida.hora}:
                  {dataConvertida.minutoFormatado}
                </h5>
                <LeftBoxInfoUnit>
                  <Switch
                    checked={checked}
              ...
              <>
                {Object.keys(weather).length !== 0 ? (
                  <>
                    ...
                    <UseOrNotUseCoat>
                      {unit === "metric"
                        ? weather.main.temp_min < 17 ||
                          weather.main.temp_max < 17
                          ? "Você deve levar um casaquinho!"
                          : "Não, você não deve levar um casaquinho!"
                        : weather.main.temp_min < 62.6 ||
                          weather.main.temp_max < 62.6
                        ? "Você deve levar um casaquinho!"
                        : "Não, você não deve levar um casaquinho!"}
                    </UseOrNotUseCoat>
                  </>
